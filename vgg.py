...
class VGGEncoder(nn.Module):
    ...
    def __init__(self, configs, enable_bn=False):
        ...
        self.conv1 = EncoderBlock(input_dim=5,   output_dim=64,  hidden_dim=64,  layers=configs[0], enable_bn=enable_bn)
...
class VGGDecoder(nn.Module):
    ...
    def __init__(self, configs, enable_bn=False):
        ...
        self.conv5 = DecoderBlock(input_dim=64,  output_dim=5,   hidden_dim=64,  layers=configs[4], enable_bn=enable_bn)
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, layers, enable_bn=False):
        ...
        conv = nn.Conv2d(in_channels=input_dim, out_channels=hidden_dim, kernel_size=3, padding=1)
        self.add_module('1 ConvAfterUp', conv)
